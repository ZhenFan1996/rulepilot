...
require_file "frontend/playwright.recommendation-production.config.ts"
require_file "frontend/e2e/home.spec.ts"
require_file "frontend/e2e/production-recommendation-journey.spec.ts"
require_file "frontend/src/main.ts"
require_file ".github/workflows/ci.yml"
require_file ".github/workflows/production-ordinary-user-smoke.yml"
require_file ".github/workflows/production-recommendation-journey.yml"
