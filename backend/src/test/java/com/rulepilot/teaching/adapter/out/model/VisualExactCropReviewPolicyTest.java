...
class VisualExactCropReviewPolicyTest {
    ...
    void reviewsOnlyHighRiskExactStepHeadings() {
        ...
        Claim workedScore = claim("步骤 3（四座小屋的得分示例）：核对印刷总分。");
        Claim points = claim("Step 4 (worked points example): verify the printed total.");
        ...
        assertThat(VisualExactCropReviewPolicy.qwenNeedsExactCropReview(List.of(workedScore))).isTrue();
        assertThat(VisualExactCropReviewPolicy.qwenNeedsExactCropReview(List.of(points))).isTrue();
