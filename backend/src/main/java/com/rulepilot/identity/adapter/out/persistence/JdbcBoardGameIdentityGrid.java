...
public class JdbcBoardGameIdentityGrid implements BoardGameIdentityGrid {
    ...
    public List<Selection> read(String username) {
        return jdbc.query(
                """
                SELECT slot, bgg_id, game_name, chinese_name, thumbnail_url, updated_at
    ...
    public Selection select(
        ...
        jdbc.update(
                ...
                INSERT INTO account_board_game_identity (
                    username, slot, bgg_id, game_name, chinese_name, thumbnail_url, updated_at)
                VALUES (:username, :slot, :bggId, :gameName, :chineseName, :thumbnailUrl, :updatedAt)
        ...
        return new Selection(slot, bggId, gameName, chineseName, thumbnailUrl, updatedAt);
    }
