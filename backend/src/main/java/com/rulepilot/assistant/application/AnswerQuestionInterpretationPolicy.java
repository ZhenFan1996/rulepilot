...
final class AnswerQuestionInterpretationPolicy {
    ...
    /** Earlier context may recover an empty current-question search; explicit learning intent is application-owned. */
    boolean canRecoverEmptyEvidence(QuestionContext context) {
        return context != null
