...
const labels = computed(() => cardLocale.value === 'zh-CN'
  ? {
      introduce: '介绍一下', select: '选这款，找规则书', details: '查看完整资料', noCover: '封面加载中', cover: '的 BGG 封面',
  ...
  : {
      introduce: 'Tell me more', select: 'Choose and find rulebook', details: 'View full details', noCover: 'Cover loading', cover: ' BGG cover',
