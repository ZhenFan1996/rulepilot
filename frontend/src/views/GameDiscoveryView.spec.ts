...
describe('GameDiscoveryView', () => {
  ...
  it('inspects attributed BGG details without mutating the catalog', async () => {
    ...
    expect(wrapper.get('[data-testid="game-cover-column"]').classes()).toContain('lg:sticky')
    expect(wrapper.get('[data-testid="game-long-details"]').classes()).toContain('lg:col-span-2')
